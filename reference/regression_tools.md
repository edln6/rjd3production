...
#> The outliers table will be written at  /tmp/RtmpsOXDVx/outliers-table1fce3ca232ed.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpsOXDVx/outliers-table1fce3ca232ed.yaml 
...
#> The td table will be written at /tmp/RtmpsOXDVx/td-table1fce2db234c5.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpsOXDVx/td-table1fce2db234c5.yaml 
