...
#> The outliers table will be written at  /tmp/Rtmp7F3s4C/outliers-table200b3c0d39f2.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmp7F3s4C/outliers-table200b3c0d39f2.yaml 
...
#> The td table will be written at  /tmp/Rtmp7F3s4C/td-table200b3436bd47.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmp7F3s4C/td-table200b3436bd47.yaml 
